...
public final class CourseInfo implements Parcelable {
    ...
    private final List<frank.google.com.ModuleInfo> mModules;

    public CourseInfo(String courseId, String title, List<frank.google.com.ModuleInfo> modules) {
        mCourseId = courseId;
        mTitle = title;
        mModules = modules;
    }
    ...
    private CourseInfo(Parcel source) {
        ...
        source.readTypedList(mModules, frank.google.com.ModuleInfo.CREATOR);
    }
    ...
    public List<frank.google.com.ModuleInfo> getModules() {
        return mModules;
    }
